...
<%
    ...
    if 'sniplay_mdsplot' in hda.creating_job.tool_id :
    ...
    elif 'sniplay_vcftoolsslidingwindow' in hda.creating_job.tool_id :
    ...
    elif 'sniplay_vcftoolsstats' in  hda.creating_job.tool_id :
    ...
    elif 'sniplay_density' in hda.creating_job.tool_id :
	per_chrom=calcul_nb_chrom(hda.file_name)
	if per_chrom=='':
		 BODY='Empty file ...'
    ...
    elif 'tassel5' in hda.creating_job.tool_id :
   ...
   #### ****** Visualisation for sNMF **********
    elif 'snmf' in hda.creating_job.tool_id :
